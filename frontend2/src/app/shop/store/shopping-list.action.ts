...
export const REMOVE_PRODUCT_FROM_CART =
  '[ShoppingCart] Remove Product from Cart';
export const INCREMENT_CART_ITEM_QUANTITY =
  '[ShoppingCart] Increment item quantity';
export const DECREMENT_CART_ITEM_QUANTITY =
  '[ShoppingCart] Decrement item quantity';
